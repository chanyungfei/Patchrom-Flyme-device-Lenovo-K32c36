...
.method public setMasterMuteForUid(ZILjava/lang/String;Landroid/os/IBinder;I)V
    ...
    invoke-static/range {v0 .. v5}, Landroid/media/AudioService;->access$11000(Landroid/media/AudioService;ZILjava/lang/String;Landroid/os/IBinder;I)V
...
.method public setRingerModeDelegate(Landroid/media/AudioManagerInternal$RingerModeDelegate;)V
    ...
    invoke-static {v0, p1}, Landroid/media/AudioService;->access$10602(Landroid/media/AudioService;Landroid/media/AudioManagerInternal$RingerModeDelegate;)Landroid/media/AudioManagerInternal$RingerModeDelegate;

    .line 6779
    iget-object v0, p0, Landroid/media/AudioService$AudioServiceInternal;->this$0:Landroid/media/AudioService;

    # getter for: Landroid/media/AudioService;->mRingerModeDelegate:Landroid/media/AudioManagerInternal$RingerModeDelegate;
    invoke-static {v0}, Landroid/media/AudioService;->access$10600(Landroid/media/AudioService;)Landroid/media/AudioManagerInternal$RingerModeDelegate;
...
.method public setStreamVolumeForUid(IIILjava/lang/String;I)V
    ...
    invoke-static/range {v0 .. v5}, Landroid/media/AudioService;->access$10900(Landroid/media/AudioService;IIILjava/lang/String;I)V
