...
.field private static final LENOVO_SAFE_VOLUME:Z = true
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 258
    iput v13, p0, Landroid/media/AudioService;->mCheckSafeMediaType:I
    ...
    .line 579
    iput v2, p0, Landroid/media/AudioService;->mMusicAndFmLimitedVolume:I
    ...
    invoke-direct {v0, v1, v2, v4, p0}, Landroid/media/MediaFocusControl;-><init>(Landroid/os/Looper;Landroid/content/Context;Landroid/media/AudioService$VolumeController;Landroid/media/AudioService;)V
    ...
    .line 677
    .local v11, "safeMusicVolumeIndex":I
    ...
    .end local v11    # "safeMusicVolumeIndex":I
...
.method static synthetic access$10500(Landroid/media/AudioService;)Landroid/media/AudioService$VolumeController;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$10600(Landroid/media/AudioService;)Landroid/media/AudioManagerInternal$RingerModeDelegate;
    .locals 1
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$10602(Landroid/media/AudioService;Landroid/media/AudioManagerInternal$RingerModeDelegate;)Landroid/media/AudioManagerInternal$RingerModeDelegate;
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method static synthetic access$10900(Landroid/media/AudioService;IIILjava/lang/String;I)V
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$11000(Landroid/media/AudioService;ZILjava/lang/String;Landroid/os/IBinder;I)V
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # I
...
.method static synthetic access$11108(Landroid/media/AudioService;)I
    .locals 2
    .param p0, "x0"    # Landroid/media/AudioService;
...
.method private adjustStreamVolume(IIILjava/lang/String;I)V
    ...
    const-string v6, "adjustStreamVolume() safe volume oldIndex="
    ...
    iget-boolean v4, v0, Landroid/media/AudioService;->mHeadsetOrHeadphoneOn:Z
    ...
    .line 1297
    invoke-virtual/range {p0 .. p0}, Landroid/media/AudioService;->disableSafeMediaVolume_ext()V
    ...
    invoke-virtual {v5, v6, v8, v10, v0}, Landroid/media/AudioService$AudioHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v5

    invoke-virtual {v4, v5}, Landroid/media/AudioService$AudioHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    invoke-direct {v0, v1, v4, v7}, Landroid/media/AudioService;->checkReActiveSafeMediaVolume(III)Z
    ...
    const-string v6, "adjustStreamVolume() checkReActiveSafeMediaVolume cvtindex= "
    ...
    invoke-direct {v0, v4}, Landroid/media/AudioService;->setReSafeMediaVolumeEnabled(Z)V

    .line 1349
    .end local v13    # "cvtindex":I
    :cond_f
    move-object/from16 v0, p0
    ...
    invoke-virtual {v5, v6, v0, v8, v10}, Landroid/media/AudioService$AudioHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method private checkForRingerModeChange(III)I
    ...
    const-string/jumbo v3, "vibrate_when_slient"
    ...
    invoke-direct {p0, v2}, Landroid/media/AudioService;->isCts(Landroid/content/Context;)Z
    ...
    const-string v3, "checkForRingerModeChange RINGER_MODE_NORMAL and VIBRATE_WHEN_SLIENT checked in settings ,we change ringermode to slient"
    ...
    const-string v3, "checkForRingerModeChange RINGER_MODE_SILENT and VIBRATE_WHEN_SLIENT checked in settings ,we change ringermode to RINGER_MODE_VIBRATE"
...
.method private onSetStreamVolume(IIII)V
    ...
    invoke-direct {p0, v3, p2, p4, v2}, Landroid/media/AudioService;->setStreamVolumeInt(IIIZ)V
    ...
    const-string/jumbo v4, "vibrate_when_slient"
    ...
    .line 1432
    .local v1, "vibrateWhenSilent":Z
    :goto_0
    if-nez v1, :cond_1

    iget-object v3, p0, Landroid/media/AudioService;->mContext:Landroid/content/Context;

    invoke-direct {p0, v3}, Landroid/media/AudioService;->isCts(Landroid/content/Context;)Z
    ...
    const-string/jumbo v4, "onSetStreamVolume index = 0 ,ringer mode change to vibrate"
    ...
    .line 1445
    .end local v1    # "vibrateWhenSilent":Z
    .local v0, "newRingerMode":I
    :goto_1
    const-string v3, "AudioService.onSetStreamVolume"

    invoke-direct {p0, v0, v3, v2}, Landroid/media/AudioService;->setRingerMode(ILjava/lang/String;Z)V
    ...
    .line 1434
    .restart local v1    # "vibrateWhenSilent":Z
    :cond_4
    const/4 v0, 0x2
    ...
    const-string/jumbo v4, "onSetStreamVolume index = 0 ,ringer mode change to Silent"
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    iget-boolean v5, v0, Landroid/media/AudioService;->mSystemReady:Z
...
.method private readAudioSettings(Z)V
    ...
    invoke-direct {p0, v5, v9}, Landroid/media/AudioService;->setRingerModeInt(IZ)V
...
.method private setRingerMode(ILjava/lang/String;Z)V
    ...
    .line 2117
    :cond_5
    const-string/jumbo v4, "persist.sys.silent"
    ...
    .restart local v2    # "ringerModeExternal":I
    .restart local v3    # "ringerModeInternal":I
    :cond_9
    if-eq p1, v3, :cond_a
...
.method private setStreamVolume(IIILjava/lang/String;I)V
    ...
    invoke-virtual {v2, v0}, Landroid/bluetooth/BluetoothA2dp;->setAvrcpAbsoluteVolume(I)V
    ...
    invoke-direct {p0, v9, v0, v2, v1}, Landroid/media/AudioService;->setSystemAudioVolume(IIII)V
    ...
    invoke-direct {p0, v11, v0, v7}, Landroid/media/AudioService;->checkSafeMediaVolume(III)Z
    ...
    const-string/jumbo v4, "setStreamVolume() safe volume oldIndex="
    ...
    const-string v4, "The mHeadsetOrHeadphoneOn value is "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-boolean v4, p0, Landroid/media/AudioService;->mHeadsetOrHeadphoneOn:Z
    ...
    .line 1529
    iget-boolean v2, p0, Landroid/media/AudioService;->mHeadsetOrHeadphoneOn:Z

    if-eqz v2, :cond_7

    div-int/lit8 v2, v9, 0xa

    iget v3, p0, Landroid/media/AudioService;->mMusicAndFmLimitedVolume:I
    ...
    .line 1530
    invoke-virtual {p0}, Landroid/media/AudioService;->disableSafeMediaVolume_ext()V
    ...
    invoke-virtual {v3, v4, v5, v6, v13}, Landroid/media/AudioService$AudioHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    const-string v3, "We have sent the MSG_SHOW_LENOVO_TOAST."

    invoke-static {v2, v3}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1543
    .end local v8    # "covtIndex":I
    :cond_7
    :goto_2
    monitor-exit v12
    :try_end_2
    ...
    invoke-direct {p0, p1, v9, v0, v1}, Landroid/media/AudioService;->sendVolumeUpdate(IIII)V

    .line 1547
    move/from16 v0, p2

    invoke-direct {p0, v11, v0, v7}, Landroid/media/AudioService;->checkReActiveSafeMediaVolume(III)Z
    ...
    const-string/jumbo v4, "setStreamVolume() checkReActiveSafeMediaVolume covtIndex= "
    ...
    .line 1551
    iput v11, p0, Landroid/media/AudioService;->mCheckSafeMediaType:I

    .line 1552
    const/4 v2, 0x1

    invoke-direct {p0, v2}, Landroid/media/AudioService;->setReSafeMediaVolumeEnabled(Z)V
    ...
    invoke-virtual {v3, v4, p1, v5, v6}, Landroid/media/AudioService$AudioHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public disableSafeMediaVolume_ext()V
    .locals 5
    ...
    const-string/jumbo v2, "setSafeMediaVolumeEnabled false."
    ...
    const-string/jumbo v2, "mPendingVolumeCommand is not null."
