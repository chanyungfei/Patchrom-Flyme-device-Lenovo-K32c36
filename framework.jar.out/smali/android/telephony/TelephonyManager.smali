...
.method public getCellLocation()Landroid/telephony/CellLocation;
    ...
    invoke-virtual {v6, v7}, Landroid/telephony/TelephonyManager;->hasIccCard(I)Z
    ...
    invoke-interface {v6, v4}, Lcom/android/internal/telephony/ITelephony;->getCellLocationBySlotId(I)Landroid/os/Bundle;
    ...
    .end local v3    # "numOfPhones":I
    :cond_0
    :goto_1
    return-object v1

    .line 747
    .restart local v3    # "numOfPhones":I
    :cond_1
    invoke-direct {p0}, Landroid/telephony/TelephonyManager;->getITelephony()Lcom/android/internal/telephony/ITelephony;

    move-result-object v6

    invoke-interface {v6}, Lcom/android/internal/telephony/ITelephony;->getCellLocation()Landroid/os/Bundle;
...
.method public getCellLocation(I)Landroid/telephony/CellLocation;
    ...
    invoke-interface {v4, p1}, Lcom/android/internal/telephony/ITelephony;->getCellLocationBySlotId(I)Landroid/os/Bundle;
...
.method public getSimAppType(I)Ljava/lang/String;
    ...
    :cond_0
    const-string v1, "gsm.sim2.apptype"
...
.method public isFTMMode()Z
    ...
    invoke-interface {v1}, Lcom/android/internal/telephony/ITelephony;->isFTMMode()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
