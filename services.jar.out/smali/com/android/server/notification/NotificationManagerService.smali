...
.field static final CLASS_TAG:Ljava/lang/String; = "NotificationManagerService"

.field static final DBG:Z

.field static final DBG_MODE:Z = true
...
.field static final LED_ALERT_ACTION:Ljava/lang/String; = "android.wingtk.intent.action.LED_ALERT_ACTION"
...
.field static final isCustomLedLightFeature:Z = true

.field static isScreenOnStatus:Z = false

.field static final isSupportLedsWhiteList:Z = true

.field private static final leds_white_list:[Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    .line 136
    sput-boolean v3, Lcom/android/server/notification/NotificationManagerService;->isScreenOnStatus:Z
    ...
    sput-object v0, Lcom/android/server/notification/NotificationManagerService;->leds_white_list:[Ljava/lang/String;
...
.method static synthetic access$1700(Lcom/android/server/notification/NotificationManagerService;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
...
.method static synthetic access$2800(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/lights/Light;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
...
.method static synthetic access$3100(Lcom/android/server/notification/NotificationManagerService;III)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/notification/NotificationManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
    ...
    .prologue
    .line 127
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/notification/NotificationManagerService;->handleLedFlashLightStatus(III)V
...
.method private handleLedFlashLightStatus(III)V
    .locals 3
    .param p1, "color"    # I
    .param p2, "onMS"    # I
    .param p3, "offMS"    # I
    ...
    .prologue
    .line 1074
    const-string v0, "NotificationManagerService"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "handleLedFlashLightStatus--->color="
    ...
    const-string v2, ",mNotificationLight"
...
.method updateLightsLocked()V
    ...
    .line 2819
    .local v5, "ledNotification":Lcom/android/server/notification/NotificationRecord;
    :cond_0
    :goto_0
    if-nez v5, :cond_1
    ...
    iget-object v13, p0, Lcom/android/server/notification/NotificationManagerService;->mLights:Ljava/util/ArrayList;
    ...
    .end local v5    # "ledNotification":Lcom/android/server/notification/NotificationRecord;
    check-cast v5, Lcom/android/server/notification/NotificationRecord;

    .line 2822
    .restart local v5    # "ledNotification":Lcom/android/server/notification/NotificationRecord;
    if-nez v5, :cond_0
    ...
    const-string v14, "LED Notification does not exist: "
    ...
    invoke-static {v12, v13}, Landroid/util/Slog;->wtfStack(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 2833
    :cond_4
    iget-object v12, v5, Lcom/android/server/notification/NotificationRecord;->sbn:Landroid/service/notification/StatusBarNotification;
    ...
    .line 2834
    .local v8, "ledno":Landroid/app/Notification;
    iget v2, v8, Landroid/app/Notification;->ledARGB:I

    .line 2835
    .local v2, "ledARGB":I
    iget v7, v8, Landroid/app/Notification;->ledOnMS:I
    ...
    .line 2837
    .local v6, "ledOffMS":I
    iget v12, v8, Landroid/app/Notification;->defaults:I
    ...
    .line 2839
    iget v7, p0, Lcom/android/server/notification/NotificationManagerService;->mDefaultNotificationLedOn:I

    .line 2840
    iget v6, p0, Lcom/android/server/notification/NotificationManagerService;->mDefaultNotificationLedOff:I
    ...
    .line 2844
    .local v4, "ledFlashLightOnFlag":Z
    :goto_2
    iget v12, v8, Landroid/app/Notification;->flags:I
    ...
    .line 2845
    .local v3, "ledDefaultLightFlag":Z
    :goto_3
    iget v12, p0, Lcom/android/server/notification/NotificationManagerService;->mDefaultNotificationLedOn:I
    ...
    .line 2846
    .local v1, "isDefaultNotificationLedMs":Z
    :goto_4
    iget-boolean v11, p0, Lcom/android/server/notification/NotificationManagerService;->mScreenOn:Z

    sput-boolean v11, Lcom/android/server/notification/NotificationManagerService;->isScreenOnStatus:Z

    .line 2849
    const-string v11, "NotificationManagerService"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string v13, "updateLightsLocked-->pkgName="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    iget-object v13, v5, Lcom/android/server/notification/NotificationRecord;->sbn:Landroid/service/notification/StatusBarNotification;
    ...
    const-string v13, ",ledFlashLightOnFlag="
    ...
    const-string v13, ",ledDefaultLightFlag="
    ...
    const-string v13, ",isDefaultNotificationLedMs="
    ...
    const-string v13, ",mNotificationPulseEnabled="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    iget-boolean v13, p0, Lcom/android/server/notification/NotificationManagerService;->mNotificationPulseEnabled:Z

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string v13, "ledARGB="
    ...
    const-string v13, ",isSupportLedsWhiteList="
    ...
    const-string v13, ",isScreenOnStatus="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    sget-boolean v13, Lcom/android/server/notification/NotificationManagerService;->isScreenOnStatus:Z
    ...
    .line 2855
    sget-boolean v11, Lcom/android/server/notification/NotificationManagerService;->isScreenOnStatus:Z
    ...
    .local v0, "i":I
    :goto_5
    sget-object v11, Lcom/android/server/notification/NotificationManagerService;->leds_white_list:[Ljava/lang/String;
    ...
    const-string v13, "leds_white_list:index="
    ...
    sget-object v13, Lcom/android/server/notification/NotificationManagerService;->leds_white_list:[Ljava/lang/String;
    ...
    const-string v13, ",SEND ACTION="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string v13, "android.wingtk.intent.action.LED_ALERT_ACTION"
    ...
    .end local v0    # "i":I
    .end local v1    # "isDefaultNotificationLedMs":Z
    .end local v3    # "ledDefaultLightFlag":Z
    .end local v4    # "ledFlashLightOnFlag":Z
    :cond_7
    move v4, v11
    ...
    .restart local v4    # "ledFlashLightOnFlag":Z
    :cond_8
    move v3, v11
    ...
    .restart local v3    # "ledDefaultLightFlag":Z
    :cond_9
    move v1, v11
    ...
    .line 2867
    .restart local v1    # "isDefaultNotificationLedMs":Z
    :cond_a
    ...
    invoke-virtual {v11, v2, v10, v7, v6}, Lcom/android/server/lights/Light;->setFlashing(IIII)V

    .line 2879
    iget-object v10, p0, Lcom/android/server/notification/NotificationManagerService;->mStatusBar:Lcom/android/server/statusbar/StatusBarManagerInternal;

    invoke-interface {v10, v2, v7, v6}, Lcom/android/server/statusbar/StatusBarManagerInternal;->notificationLightPulse(III)V
