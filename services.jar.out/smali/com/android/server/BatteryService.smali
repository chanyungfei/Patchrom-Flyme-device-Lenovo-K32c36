...
.method static synthetic access$1400(Lcom/android/server/BatteryService;I)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BatteryService;
    .param p1, "x1"    # I
...
.method private batteryWarningDialog()V
    ...
    const-string v1, "/mnt/sdcard/adb_enable"
    ...
    .line 404
    :cond_2
    iput v3, p0, Lcom/android/server/BatteryService;->batteryWarningType:I
...
.method private update(Landroid/os/BatteryProperties;)V
    ...
    iget v2, p1, Landroid/os/BatteryProperties;->batteryLevel:I
    ...
    iput v0, p1, Landroid/os/BatteryProperties;->batteryStatus:I
