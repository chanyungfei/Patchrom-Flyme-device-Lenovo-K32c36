...
.field protected static final DATA_STALL_ENABLED:Z
...
.field protected static final RECONNECT_DELAY_DEFAULT_MILLIS:I = 0x2ee0
...
.method static constructor <clinit>()V
    ...
    .line 174
    const-string v0, "persist.radio.datastall"

    invoke-static {v0, v1}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->DATA_STALL_ENABLED:Z
...
.method protected onReconnectAfterWifiOff(I)V
    .locals 7
    .param p1, "currSubId"    # I
    ...
    const-string v5, "onReconnectAfterWifiOff: currSubId = "
    ...
    .line 404
    :cond_0
    const-string v4, "receive onReconnectAfterWifiOff but subId incorrect, ignore"
    ...
    const-string v5, "onReconnectAfterWifiOff: mState="
    ...
    const-string v5, "onReconnectAfterWifiOff: apnContext state="
    ...
    .line 424
    :cond_3
    const-string v4, "onReconnectAfterWifiOff: state is FAILED|IDLE, disassociate"
    ...
    invoke-virtual {v2, v0, v4, v6}, Lcom/android/internal/telephony/dataconnection/DcAsyncChannel;->tearDown(Lcom/android/internal/telephony/dataconnection/ApnContext;Ljava/lang/String;Landroid/os/Message;)V
    ...
    .line 433
    :cond_5
    const-string v4, "onReconnectAfterWifiOff: keep associated"
...
.method protected startDataStallAlarm(Z)V
    ...
    sget-boolean v3, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->DATA_STALL_ENABLED:Z

    if-nez v3, :cond_0

    .line 1806
    const-string v3, "startDataStallAlarm, data stall is not enabled"
