...
.method public copySmsToIcc(Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;I)Ljava/lang/String;
    ...
    .line 1741
    .local v13, "records":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/telephony/SmsRawData;>;"
    :try_start_0
    ...
    invoke-interface/range {v3 .. v10}, Lcom/android/internal/telephony/ISms;->getIccPdu(Ljava/lang/String;Ljava/lang/String;JLjava/util/List;II)Ljava/util/List;
    ...
    invoke-interface {v3, v0, v4, v1, v5}, Lcom/android/internal/telephony/ISms;->copyMessageToIccEfReturnIndex(I[B[BI)I

    move-result v12

    .line 1754
    .local v12, "iccIndex":I
    if-nez v11, :cond_2
    ...
    .line 1749
    .end local v12    # "iccIndex":I
    .end local v17    # "smscByte":[B
    :cond_1
    const/16 v17, 0x0
    ...
    .line 1759
    .restart local v12    # "iccIndex":I
    .restart local v17    # "smscByte":[B
    :cond_2
    :try_start_3
...
.method public getSmscOnIcc()Ljava/lang/String;
    ...
    .prologue
    .line 1797
    invoke-virtual {p0}, Landroid/telephony/SmsManager;->getSmscAddressFromIcc()Ljava/lang/String;

    move-result-object v0

    .line 1798
    .local v0, "smsc":Ljava/lang/String;
    invoke-direct {p0, v0}, Landroid/telephony/SmsManager;->getSmscSubString(Ljava/lang/String;)Ljava/lang/String;
...
.method public updateSmscOnIcc(Ljava/lang/String;)Z
    ...
    .prologue
    .line 1805
    invoke-virtual {p0, p1}, Landroid/telephony/SmsManager;->setSmscAddressToIcc(Ljava/lang/String;)Z
