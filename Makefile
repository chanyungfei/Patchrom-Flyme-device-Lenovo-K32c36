...
#-----------------------------------------------------------------------------
vendor_remove_files := build.prop.bakforspec recovery-from-boot.bak
...
vendor_saved_apps := Bluetooth KeyChain HTMLViewer UserDictionaryProvider BackupRestoreConfirmation \
                     ...
                     ProxyHandler Shell DefaultContainerService CameraStability FMService \
		     MaxxAudio MaxxService shutdownlistener Stk TimeService WTCamera
...
#-----------------------------------------------------------------------------
board_modify_apps := MzCallSetting SystemUI Telecom TeleService
