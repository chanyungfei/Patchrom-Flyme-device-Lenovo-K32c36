...
.field HOOK_DEBOUNCE_DELAY_MILLIS:I

.field private last_keyEvent_time:J
...
.field mKey_event:Landroid/view/KeyEvent;
...
.field mMediaKeyCode:I

.field mMediaKeyCode_Delay_Millis:I
...
.field private final mSendMediaKeyEvent:Ljava/lang/Runnable;
...
.field private miskeypresslong:Z
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->HOOK_DEBOUNCE_DELAY_MILLIS:I

    .line 711
    iput v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeKeyCode:I

    .line 712
    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->miskeypresslong:Z

    .line 713
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->last_keyEvent_time:J

    .line 716
    iput v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMediaKeyCode:I

    .line 717
    const/16 v0, 0x1f4

    iput v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMediaKeyCode_Delay_Millis:I
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSendHookKeyEvent:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSendMediaKeyEvent:Ljava/lang/Runnable;
...
.method static synthetic access$2400(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/view/KeyEvent;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/policy/impl/PhoneWindowManager;
    ...
    .prologue
    .line 167
    invoke-direct {p0, p1, p2}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendSimulatedMediaKeyEvent(Landroid/view/KeyEvent;I)V
...
.method private delaySendHookKeyEvent()V
    ...
    const-string v1, "lzf delaySendHookKeyEvent "
    ...
    iget-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSendHookKeyEvent:Ljava/lang/Runnable;

    iget v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->HOOK_DEBOUNCE_DELAY_MILLIS:I
...
.method private delaySendMediaKeyEvent()V
    .locals 4
    ...
    const-string v1, "lzf delaySendMediaKeyEvent "
    ...
    iget-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSendMediaKeyEvent:Ljava/lang/Runnable;

    iget v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMediaKeyCode_Delay_Millis:I
...
.method private removeSendHookKeyEvent()V
    ...
    const-string v1, "lzf removeSendHookKeyEvent "
...
.method private removeSendMediaKeyEvent()V
    ...
    const-string v1, "lzf removeSendMediaKeyEvent "
...
.method private sendSimulatedMediaKeyEvent(Landroid/view/KeyEvent;I)V
    .locals 2
...
.method private updateSystemUiVisibilityLw()I
    ...
    .line 7245
    invoke-static {v4, v2}, Lcom/lenovo/romui/hook/RomUI_HookPhoneWindowManager;->updateStatusBarVisibility(Landroid/view/WindowManagerPolicy$WindowState;I)I
...
.method dispatchVolumeKeyToService(Landroid/view/KeyEvent;)V
    .locals 2
    .param p1, "event"    # Landroid/view/KeyEvent;
    ...
    invoke-virtual {v0, p1, v1}, Landroid/media/session/MediaSessionLegacyHelper;->sendVolumeKeyEvent(Landroid/view/KeyEvent;Z)V
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    .line 2856
    .local v58, "virtualKey":Z
    :goto_2
    const-wide/16 v34, 0x0

    .line 2858
    .local v34, "keyEvent_time":J
    ...
    .line 2865
    .local v50, "telecomManager":Landroid/telecom/TelecomManager;
    move-object/from16 v0, p0
    ...
    .line 2881
    .local v30, "isAlarmBoot":Ljava/lang/String;
    if-eqz v30, :cond_8
    ...
    .end local v30    # "isAlarmBoot":Ljava/lang/String;
    .end local v34    # "keyEvent_time":J
    .end local v36    # "longPress":Z
    .end local v50    # "telecomManager":Landroid/telecom/TelecomManager;
    .end local v58    # "virtualKey":Z
    :cond_4
    const/16 v25, 0x0
    ...
    .line 2870
    .restart local v34    # "keyEvent_time":J
    .restart local v50    # "telecomManager":Landroid/telecom/TelecomManager;
    .restart local v58    # "virtualKey":Z
    :catch_0
    move-exception v26
    ...
    .restart local v30    # "isAlarmBoot":Ljava/lang/String;
    :cond_7
    move-object/from16 v0, p0
    ...
    .line 2954
    .local v37, "mActivityManager":Landroid/app/ActivityManager;
    const/4 v4, 0x1
    ...
    .line 2955
    .local v51, "topActivity":Landroid/content/ComponentName;
    invoke-virtual/range {v51 .. v51}, Landroid/content/ComponentName;->getClassName()Ljava/lang/String;

    move-result-object v21

    .line 2956
    .local v21, "classname":Ljava/lang/String;
    invoke-virtual/range {v51 .. v51}, Landroid/content/ComponentName;->getPackageName()Ljava/lang/String;
    ...
    .line 2961
    .local v41, "mintent":Landroid/content/Intent;
    ...
    .line 2967
    .end local v41    # "mintent":Landroid/content/Intent;
    :cond_11
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v50 .. v50}, Landroid/telecom/TelecomManager;->isRinging()Z
    ...
    .line 2990
    invoke-virtual/range {v50 .. v50}, Landroid/telecom/TelecomManager;->acceptRingingCall()V
    ...
    .end local v37    # "mActivityManager":Landroid/app/ActivityManager;
    .end local v44    # "pkgname":Ljava/lang/String;
    .end local v51    # "topActivity":Landroid/content/ComponentName;
    :cond_19
    if-eqz p1, :cond_1c
    ...
    .line 3045
    .restart local v48    # "startTorch":Z
    :cond_1e
    ...
    .line 3102
    .restart local v37    # "mActivityManager":Landroid/app/ActivityManager;
    const/4 v4, 0x1
    ...
    .line 3103
    .restart local v51    # "topActivity":Landroid/content/ComponentName;
    invoke-virtual/range {v51 .. v51}, Landroid/content/ComponentName;->getClassName()Ljava/lang/String;

    move-result-object v21

    .line 3104
    .restart local v21    # "classname":Ljava/lang/String;
    const-string v4, "com.mediatek.factorymode.Keypad_test_Activity"
    ...
    .line 3106
    .restart local v41    # "mintent":Landroid/content/Intent;
    ...
    const-string v6, "KeyEvent.KEYCODE_MENU-----MENU_keytest:"
    ...
    .line 3245
    .local v59, "voiceIntent":Landroid/content/Intent;
    :goto_c
    ...
    .line 3467
    .end local v59    # "voiceIntent":Landroid/content/Intent;
    :cond_49
    :goto_d
    move-object/from16 v0, p0
    ...
    .line 3243
    .restart local v59    # "voiceIntent":Landroid/content/Intent;
    ...
    const-string v4, "msm8x16-skuh-snd-card Button Jack"
    ...
    const-string v6, "lzf KEYCODE_VOLUME_UP  NO handset key:"
    ...
    const-string v7, "lzf KEYCODE_VOLUME_UP  isMusicActive:"
    ...
    invoke-virtual/range {v50 .. v50}, Landroid/telecom/TelecomManager;->isInCall()Z
    ...
    .line 3331
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->removeSendHookKeyEvent()V

    .line 3333
    :try_start_3
    const-string v4, "WindowManager"

    const-string v6, "lzf KEYCODE_VOLUME_UP longPress "
    ...
    invoke-direct {v0, v1, v4}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendSimulatedMediaKeyEvent(Landroid/view/KeyEvent;I)V
    ...
    iput-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->miskeypresslong:Z
    ...
    iget-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->miskeypresslong:Z
    ...
    const-string v7, "lzf KEYCODE_VOLUME_UP keyEvent_time="
    ...
    iget-wide v8, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->last_keyEvent_time:J
    ...
    iget-wide v6, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->last_keyEvent_time:J

    sub-long v6, v34, v6

    move-object/from16 v0, p0

    iget v4, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->HOOK_DEBOUNCE_DELAY_MILLIS:I
    ...
    iput-wide v0, v2, Lcom/android/internal/policy/impl/PhoneWindowManager;->last_keyEvent_time:J
    ...
    iput v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeKeyCode:I

    .line 3362
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->delaySendHookKeyEvent()V
    ...
    const-string v7, "lzf KEYCODE_VOLUME_UP miskeypresslong  "
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->miskeypresslong:Z
    ...
    const-string v6, "lzf KEYCODE_VOLUME_DOWN  NO handset key:"
    ...
    const-string v7, "lzf KEYCODE_VOLUME_DOWN  isMusicActive:"
    ...
    const-string v6, "lzf KEYCODE_VOLUME_DOWN longPress "
    ...
    const-string v7, "lzf KEYCODE_VOLUME_down keyEvent_time="
    ...
    const-string v7, "lzf KEYCODE_VOLUME_DOWN miskeypresslong  "
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;I)I
    ...
    .line 5479
    .local v14, "down_time":J
    invoke-virtual/range {p1 .. p1}, Landroid/view/KeyEvent;->getEventTime()J

    move-result-wide v16

    .line 5482
    .local v16, "event_time":J
    const-string v29, "sys.quickboot.enable"
    ...
    .end local v14    # "down_time":J
    .end local v16    # "event_time":J
    .end local v19    # "interactive":Z
    ...
    .line 5474
    .restart local v19    # "interactive":Z
    :cond_4
    const/4 v12, 0x0
    ...
    .restart local v14    # "down_time":J
    .restart local v16    # "event_time":J
    ...
    :cond_9
    :goto_7
    invoke-static/range {v22 .. v22}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isValidGlobalKey(I)Z
    ...
    .line 5503
    .restart local v20    # "isInjected":Z
    :cond_b
    if-eqz v19, :cond_c
    ...
    invoke-virtual/range {v29 .. v29}, Lcom/android/internal/policy/impl/keyguard/KeyguardServiceDelegate;->isShowing()Z
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isWakeKeyEnabled(I)Z
    ...
    const-string v30, "keyguard_min_interval_two_power_key"
    ...
    const-string v31, "KEYGUARD_MIN_INTERVAL_TWO_POWER_KEY, currentTime="
    ...
    const-string v31, ",mLastPowerKeyDownTime="
    ...
    const-string v31, ",mKeyguardMinIntervalTwoKeyguardKey="
    ...
    .end local v28    # "useHapticFeedback":Z
    :cond_14
    const/16 v28, 0x0
    ...
    .restart local v28    # "useHapticFeedback":Z
    :cond_15
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/view/InputDevice;->getName()Ljava/lang/String;
    ...
    const-string v31, "lzf KEYCODE_VOLUME_DOWN  isMusicActive:"
    ...
    const-string v31, " isWiredHeadsetOn:"
    ...
    const-string v29, "msm8x16-skuh-snd-card Button Jack"
    ...
    const-string v30, "lzf screen off KEYCODE_VOLUME_DOWN handset key:"
    ...
    iput-object v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKey_event:Landroid/view/KeyEvent;
    ...
    iput v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMediaKeyCode:I

    .line 5608
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->delaySendMediaKeyEvent()V
    ...
    .line 5687
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/TelecomManager;->isRinging()Z
    ...
    .line 5699
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/TelecomManager;->silenceRinger()V
    ...
    :cond_1c
    sub-long v30, v16, v14

    move-object/from16 v0, p0

    iget v0, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMediaKeyCode_Delay_Millis:I
    ...
    .line 5618
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->removeSendMediaKeyEvent()V
    ...
    const-string v31, "lzf KEYCODE_VOLUME_UP  isMusicActive:"
    ...
    const-string v30, "lzf screen off KEYCODE_VOLUME_UP handset key:"
    ...
    :cond_21
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/TelecomManager;->isInCall()Z
    ...
    invoke-static/range {v29 .. v29}, Landroid/media/session/MediaSessionLegacyHelper;->getHelper(Landroid/content/Context;)Landroid/media/session/MediaSessionLegacyHelper;
    ...
    .line 5735
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/TelecomManager;->endCall()Z
    ...
    invoke-static/range {v31 .. v31}, Landroid/view/ViewConfiguration;->get(Landroid/content/Context;)Landroid/view/ViewConfiguration;

    move-result-object v31

    invoke-virtual/range {v31 .. v31}, Landroid/view/ViewConfiguration;->getDeviceGlobalActionKeyTimeout()J
    ...
    invoke-virtual/range {v29 .. v33}, Landroid/os/PowerManager;->goToSleep(JII)V
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/android/internal/policy/impl/ImmersiveModeConfirmation;->onPowerKeyDown(ZJZ)Z
    ...
    invoke-interface/range {v29 .. v30}, Landroid/os/IHardwareService;->setButtonLightEnabled(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptPowerKeyDown(Landroid/view/KeyEvent;Z)V
    ...
    const-string v30, "remote call for turn off button light failed."
    ...
    const-string v31, "org.codeaurora.PowerKeyDown.Mute"
    ...
    invoke-direct {v0, v1, v2, v7}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptPowerKeyUp(Landroid/view/KeyEvent;ZZ)V
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/os/PowerManager;->isInteractive()Z
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/media/session/MediaSessionLegacyHelper;->isGlobalPriorityActive()Z
    ...
    .line 5871
    invoke-virtual/range {v27 .. v27}, Landroid/telecom/TelecomManager;->acceptRingingCall()V
